...
class App extends Component {
  ...
  componentDidMount() {
    ...
    for (var item of text) {
      fetch(`https://api.flickr.com/services/rest/?method=flickr.photos.search&pages=1&per_page=10&api_key=${key}&format=json&nojsoncallback=1&text=${item}&extras=url_o`
